...
public class AccountView extends JFrame {
	...
	private JLabel accountBnr, firstNameLbl, lastNameLbl, dobLbl, accountIdLbl, acctChkLbl, acctSvgLbl, 
	changePinLbl, confirmNewPinLbl, acctSvgLblResult, acctChkLblResult, accountIdLblResult, dobLblResult,
	lastNameLblResult, firstNameLblResult;
	...
	private void updateFields(User currentUser) {
		User temp = currentUser;
		//acctSvgLblResult.setText();
		//acctChkLblResult.setText();
		//accountIdLblResult.setText(temp.getUserId());
		//dobLblResult.setText(temp.getDob());
		lastNameLblResult.setText(temp.getLastName());
		firstNameLblResult.setText(temp.getFirstName());
	}
